...
class Okienko(Frame):
    ...
    def createWidgets(self):
        ...
        self.label1["text"] = "Ilość przediałów(domyślna wartość to pierwiastek z ilości danych)"
        self.label1.grid(row=1)

        self.label2 = Label(self)
        self.label2["text"] = "Ilość danych(dane są generowane na podstawie rozkładu normalnego)"
        self.label2.grid(row=4)

        self.label3 = Label(self)
        self.label3["text"] = "Wartość oczekiwana"
